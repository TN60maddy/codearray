...
my_array.sort(ascending = True)
sort_values = my_array.get_elements()
print(f"Sorted Array in Ascending Order : {sort_values}")
my_array.sort(ascending = False)
sort_values_descending = my_array.get_elements()
print(f"sorted Array in Descending Order : {sort_values_descending}.")
